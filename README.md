...
The `SPARTNMessage` class implements a provisional decrypt and decode for OCB, HPAC and GAD message types but it has not yet been fully validated:
 ...
 - HPAC payload decode appears to be working OK, but results have not yet been fully validated and some may be incorrect.
 - OCB payload decode appears to be working OK, but results have not yet been fully validated and some may be incorrect.
